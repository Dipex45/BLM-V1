...
export const BookingSchema = z.object({
  ...
  customerPhone: z.string().min(5, "Phone number is required").max(40),
  ...
  touringPackage: z.string().max(120).optional(),
  touringState: z.string().max(80).optional(),
  internationalCountry: z.string().max(80).optional(),
  logisticsDetails: z.string().max(2000).optional().default(''),
  packageWeightKg: z.number().positive().optional(),
  carHireVehicle: z.string().max(120).optional(),
  carHireDurationDays: z.number().int().min(1).max(365).optional(),
  carHireWithDriver: z.boolean().optional(),
  pickupHub: z.string().max(200).optional(),
